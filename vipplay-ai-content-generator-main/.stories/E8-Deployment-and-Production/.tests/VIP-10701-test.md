# VIP-10701: Environment Configuration - Test Specification

## Feature: Environment Configuration
Automated test specification for VIP-10701
...
When I perform the primary action for "Environment Configuration"
