# VIP-10507: Superadmin Access Control - Test Specification

## Feature: Superadmin Access Control
Automated test specification for VIP-10507
...
When I attempt to access any /api/admin/ai/* endpoint
...
#### Scenario: Superadmin can access all endpoints
```gherkin
Given I am logged in as a superadmin user
When I access /api/admin/ai/models
And I access /api/admin/ai/groups
And I access /api/admin/ai/config
Then all requests should return 200, 201, or 202 status
And I should receive the expected data
```

#### Scenario: Invalid token rejected
```gherkin
Given I have an invalid or expired JWT token
When I attempt to access /api/admin/ai/models with Authorization header
Then the response status should be 401 Unauthorized
...
When I attempt to access /api/admin/ai/models
Then the response status should be 401 Unauthorized
And the response should contain "Unauthorized"
```
