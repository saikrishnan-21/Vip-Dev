# VIP-10307: Content List/Filter - Test Specification

## Feature: Content List/Filter
Automated test specification for VIP-10307
...
When I perform the primary action for "Content List/Filter"
