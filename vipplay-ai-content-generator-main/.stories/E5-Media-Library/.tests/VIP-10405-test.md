# VIP-10405: Attach Media to Content - Test Specification

## Feature: Attach Media to Content
Automated test specification for VIP-10405
...
When I perform the primary action for "Attach Media to Content"
